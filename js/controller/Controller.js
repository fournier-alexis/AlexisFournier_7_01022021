...
export default class Controller {
  ...
  constructor() {
    ...
    this.filters = [];
    this.currentRecipes = Controller.listRecipe;
    this.currentIngredients = Controller.listIngredients;
    this.currentAppliances = Controller.listAppliance;
    this.currentUstensils = Controller.listUstensils;
  ...
  sortByName(value) {
    let filteredRecipes;
    filteredRecipes = this.sortByTags().filter(
      (recipe) =>
   ...
   */
  sortByTags() {
    let filteredRecipes = Controller.listRecipe;
